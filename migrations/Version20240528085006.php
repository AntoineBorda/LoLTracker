 ...
 */
final class Version20240528085006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE team (id INT AUTO_INCREMENT NOT NULL, player_id VARCHAR(255) DEFAULT NULL COLLATE `utf8_bin`, data_team_id BIGINT UNSIGNED DEFAULT NULL, INDEX IDX_C4E0A61F99E6F5DF (player_id), INDEX IDX_C4E0A61F4D678E5F (data_team_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
