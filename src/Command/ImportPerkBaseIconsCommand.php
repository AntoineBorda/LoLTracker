...
#[AsCommand(
    name: 'app:import-perkbaseicons',
)]
class ImportPerkBaseIconsCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Import perkbase icons into the database.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $url = 'https://raw.communitydragon.org/latest/game/assets/perks/styles/';
        $projectDir = $this->parameterBag->get('kernel.project_dir');
        $localPath = $projectDir.'/assets/img/communitydragon/lol-game-data/assets/v1/perk-images/styles/';
        ...
        $io->success('Perkbase icons imported successfully!');
