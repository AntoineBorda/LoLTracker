...
#[AsCommand(
    name: 'app:import-perkstaticons',
)]
class ImportPerkStatIconsCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Import perkstat icons into the database.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $localPath = $projectDir.'/assets/img/communitydragon/lol-game-data/assets/v1/perk-images/statmods/';
        ...
        $io->success('Perkstat icons imported successfully!');
