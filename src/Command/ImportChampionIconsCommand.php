...
#[AsCommand(
    name: 'app:import-championicons',
)]
class ImportChampionIconsCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Import champion icons into the database.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $localPath = $projectDir.'/assets/img/communitydragon/lol-game-data/assets/v1/champion-icons/';
        ...
        $io->success('Champion icons imported successfully!');
