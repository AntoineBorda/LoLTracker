...
#[AsCommand(
    name: 'app:import-itemicons',
)]
class ImportItemIconsCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Import item icons into the database.');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $url = 'https://raw.communitydragon.org/latest/game/assets/items/icons2d/';
        $projectDir = $this->parameterBag->get('kernel.project_dir');
        $localPath = $projectDir.'/assets/img/communitydragon/lol-game-data/assets/assets/items/icons2d/';
        ...
        $io->success('Item icons imported successfully!');
