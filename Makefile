...
## === ⭐  CUSTOM PROJECT =================================================
load-data: ## Load Data.
	$(SYMFONY_CONSOLE) app:load-champions && $(SYMFONY_CONSOLE) app:load-countries && $(SYMFONY_CONSOLE) app:load-items && $(SYMFONY_CONSOLE) app:load-perks && $(SYMFONY_CONSOLE) app:load-queues && $(SYMFONY_CONSOLE) app:load-summoners
.PHONY: load-data

load-data-rapid: ## Load Data from Rapid Api.
	$(SYMFONY_CONSOLE) app:load-leagues && $(SYMFONY_CONSOLE) app:load-players && $(SYMFONY_CONSOLE) app:load-teams
.PHONY: load-data-rapid

associate-data: ## Load Association.
	$(SYMFONY_CONSOLE) app:associate-playerleague && $(SYMFONY_CONSOLE) app:associate-playerteam
.PHONY: associate-data

import-icons: ## Import Icons.
	$(SYMFONY_CONSOLE) app:import-championicons && $(SYMFONY_CONSOLE) app:import-divisionicons && $(SYMFONY_CONSOLE) app:import-itemicons && $(SYMFONY_CONSOLE) app:import-perkbaseicons && $(SYMFONY_CONSOLE) app:import-perkicons && $(SYMFONY_CONSOLE) app:import-perkstaticons && $(SYMFONY_CONSOLE) app:import-roleicons && $(SYMFONY_CONSOLE) app:import-spellicons
.PHONY: import-icons

update-trackers: ## Load.
	$(SYMFONY_CONSOLE) app:update-trackers
.PHONY: update-tracker
#---------------------------------------------#
